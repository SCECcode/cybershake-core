...
def run_det_surf_model(gridout, coords, models):
	...
	cmd = "aprun -n 1 %s/UCVM/bin/determine_surface_model %s %s %s %s" % (CS_PATH, gridout, coords, models, output_file)
	print cmd
...
os.environ["LD_LIBRARY_PATH"] = "/lustre/atlas/proj-shared/geo112/CyberShake/software/UCVM/ucvm-15.10.0/lib/euclid3/lib:/lustre/atlas/proj-shared/geo112/CyberShake/software/UCVM/ucvm-15.10.0/lib/proj-4/lib:/lustre/atlas/proj-shared/geo112/CyberShake/software/UCVM/ucvm-15.10.0/model/cvms426/lib:/lustre/atlas/proj-shared/geo112/CyberShake/software/UCVM/ucvm-15.10.0/model/cencal/lib:/lustre/atlas/proj-shared/geo112/CyberShake/software/UCVM/ucvm-15.10.0/model/cvms5/lib:/lustre/atlas/proj-shared/geo112/CyberShake/software/UCVM/ucvm-15.10.0/model/cca/lib:%s" % (os.environ["LD_LIBRARY_PATH"])
