...
set BPROG = bin/ucvm-single-mpi-15.10
...
set UCVM_HOME = /lustre/atlas/proj-shared/geo112/CyberShake/software/UCVM/ucvm-15.10.0
setenv LD_LIBRARY_PATH ${UCVM_HOME}/lib/euclid3/lib:${UCVM_HOME}/lib/proj-4/lib:${UCVM_HOME}/model/cvms426/lib:${UCVM_HOME}/model/cencal/lib:${UCVM_HOME}/model/cvms5/lib:${UCVM_HOME}/model/cca/lib
