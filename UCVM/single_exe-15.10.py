...
if option.min_vs is not None:
        command = '%s/single_exe-15.10.csh %s %s %d %d %d %s %s %s %s %s %s %s %.01f' % (sys.path[0], site, modelcords, ns[0], ns[1], ns[2], cs_path, scratch_path, log_root, models, mpi_cmd, job_id, format, option.min_vs)
else:
	command = '%s/single_exe-15.10.csh %s %s %d %d %d %s %s %s %s %s %s %s' % (sys.path[0], site, modelcords, ns[0], ns[1], ns[2], cs_path, scratch_path, log_root, models, mpi_cmd, job_id, format)
print command
