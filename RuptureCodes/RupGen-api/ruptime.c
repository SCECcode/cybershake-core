...
void get_headtime(struct velmodel *mod, int slay, double *sth, int rlay, 
		  double *rth, double *rad, float *tt);

void bisect_p(struct velmodel *vm, int slay, double *sth, int rlay,
	      double *rth, double *p, double *eps, float *tol,
	      double *rng, int linc);

void get_range(struct velmodel *vm, int slay, double *sth,
	       int rlay, double *rth, double *p, double *r0, int linc);

void get_radtime(struct velmodel *vm, int slay, double *sth,
		 int rlay, double *rth, double *p, double *r0,
		 float * tt, int linc);
