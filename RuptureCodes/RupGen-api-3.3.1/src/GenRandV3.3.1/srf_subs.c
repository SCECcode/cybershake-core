...
int _gen_Mliu_stf(float *slip,float *t0,float *stf,int nt,float *dt)
{
int it, nstf;
float tau, tau1, tau2, tau1x2, arg1, arg2;
float sum, t, alpha;
...
void _load_slip_srf_dd2(struct standrupformat *srf,struct stfpar2 *spar,struct pointsource *ps,long *seed)
{
struct srf_allpoints *apnts_ptr;
struct srf_apointvalues *apval_ptr;
struct srf_prectsegments *prseg_ptr;
...
float dmin2, dmax2;
float rtfac, tzero;
float rtfac1, rtfac2, sabs, slip_max, slip_min;
float rtfac_min = 0.05;
