...
!     ------------------------------------------------------------------
      ...
      subroutine Calc_RotD(jInterp, npair, npts_in, dt_in, acc1_0, acc2_0, rotD100, rD100ang, rotD50, nFreq, RSP_Period)
       
      parameter (MAXPTS = 2000000)

      character*80 fileacc1, fileacc2, filein, fileout
      integer npts_in, npts1, npts2, npts, npair, nhead, iFlag
      real dt_in, dt1, dt2, dt, acc1(MAXPTS), acc2(MAXPTS), acc1_0(MAXPTS), acc2_0(MAXPTS)
      real dt10
...
!      data RSP_Period / 2.000, 2.200, 2.400, 2.600, 2.800, 3.000, 3.500, 4.000, 4.400, 5.000, 5.500, 6.000, 6.500, 7.500, 8.500, 10.000 /
...
!        read (30,'( a80)') fileout
!        write(*,*) fileout
!        open (40,file=fileout,status='replace')

!       Write RotD50 and Psa5 file
!        write (40,'(''#'', 2x, ''Psa5_N'', x, ''Psa5_E'', x, ''RotD100'')')
