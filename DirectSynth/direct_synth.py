...
if MPI_CMD=="aprun":
    ...
    cmd = "export PYTHONPATH=/work2/00349/scottcal/frontera/CyberShake/software/DirectSynth/src/duration:$PYTHONPATH; export LD_LIBRARY_PATH=/work2/00349/scottcal/frontera/CyberShake/utils/libmemcached_1.0.18/lib:$LD_LIBRARY_PATH; ibrun %s" % ds_path
print(cmd)
rc = os.system(cmd)
sys.exit((rc >> 8) & 0xFF)
