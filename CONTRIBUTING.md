# Contributing to CyberShake

This document provides an overview on how to contribute to CyberShake, and will provide step-by-step instructions on a practical contribution workflow.
...
* Install the main branch of the SCECcode/cybershake-core.git repository
...
5. Push your changes to your fork and submit a pull request. Make sure to set the branch to `cybershake-core:dev`.
...
Please open an issue if you want to ask a question about CyberShake-core.
...
* Cybershake-core version, Compiler versions and Platform (Linux, HPC-system, etc)
* How did you install Cybershake-core (from source...)
