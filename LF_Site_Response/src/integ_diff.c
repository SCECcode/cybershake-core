...
//float *seis;
float sec, edist, az, baz;
int hr, min, i, j, nt6;
int integ = integ_notdiff;
int diff = !integ_notdiff;
int rtrend = 0;
int rbase = 0;
int dmean = 0;
int dtrend = 0;
...
t1t2(s,nt,dt,t1,t2,tf1,tf2,iv0)
